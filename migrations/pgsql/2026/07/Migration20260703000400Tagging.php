...
class Migration20260703000400Tagging extends BaseMigration
{
    protected function up(): void
    {
        ...
        $this->addSql('CREATE TABLE "taggables" ("taggable_type" VARCHAR(255) NOT NULL, "taggable_id" VARCHAR(36) NOT NULL, "tag_id" INTEGER NOT NULL, PRIMARY KEY ("taggable_type", "taggable_id", "tag_id"), CONSTRAINT "fk_taggables_tag_id" FOREIGN KEY ("tag_id") REFERENCES "tags"("id"))');
