...
class Migration20260622000400Tagging extends BaseMigration
{
    protected function up(): void
    {
        $this->addSql("CREATE TABLE `tags` (`id` INT UNSIGNED AUTO_INCREMENT, `name` VARCHAR(80) NOT NULL, `slug` VARCHAR(120) NOT NULL, PRIMARY KEY (`id`), UNIQUE INDEX `uniq_tags_slug` (`slug`))");
