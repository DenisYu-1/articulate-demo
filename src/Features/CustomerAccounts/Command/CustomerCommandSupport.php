...
trait CustomerCommandSupport
{
    ...
    private function createCustomer(string $name, string $email, ?Address $address = null, string $status = 'active'): Customer
    {
    ...
    private function createCustomerWithAddress(string $name, string $email, string $addressLabel): Customer
    {
        ...
        $customer = $this->createCustomer($name, $email, $address);
